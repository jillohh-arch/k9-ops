...
export function NutritionPlanCreateDialog({
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="flex min-w-0 flex-col max-h-[calc(100vh-12rem)]">
        {/* Scrollable content area */}
        <div className="min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-auto px-3 py-1 sm:px-5 space-y-6">
        ...
        <fieldset disabled={isExecuting || isSuccess} className="min-w-0 space-y-6">
          ...
          <div className="min-w-0 rounded-2xl border border-slate-800/60 bg-slate-900/40 p-4 sm:p-5 space-y-4">
            <div className="flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Button
                ...
                className="w-full text-xs border-cyan-500/30 text-cyan-200 hover:bg-cyan-500/10 sm:w-auto"
              >
