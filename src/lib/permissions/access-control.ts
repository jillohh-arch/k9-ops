...
export function getProfileIdFromLegacyValue(value: string | null | undefined) {
  ...
  const aliases: Record<string, string> = {
    ...
    almoxarifado_estoque: "almoxarifado",
    comando: "subinspetor_inspetor",
    condutor: "condutor",
    consulta: "condutor",
    ...
    leitura: "condutor",
    operacional: "subinspetor_inspetor",
    subinspetor: "subinspetor_inspetor",
    subinspetor_inspetor: "subinspetor_inspetor",
    supervisor: "subinspetor_inspetor",
    supervisor_operacional: "subinspetor_inspetor",
    veterinario: "subinspetor_inspetor",
    vet: "subinspetor_inspetor",
  };
